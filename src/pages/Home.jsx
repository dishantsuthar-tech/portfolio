...
const Home = () => {
return ( <main className="home"> <section className="hero">
{/* Particles Background */} <div className="particles-background">
<Particles
...
```
    ...
    <div className="hero-container hero-content">
      ...
      <p className="hero-description">
        ...
        building clean, responsive, and modern web applications using
        HTML, CSS, JavaScript, Tailwind CSS, and React.js. Currently,
        I'm learning Backend Development, the MERN Stack, and Data
        Structures & Algorithms on my journey to becoming a Full Stack
        Developer.
      </p>
